...
function AppContent() {
  ...
  const RegisterPage = () => {
    ...
    const handleRegister = async () => {
      ...
      setRegLoading(true);
      const result = await authService.register(regName.trim(), regEmail.trim(), regPassword, regPhone.trim());
      setRegLoading(false);
          ...
          <div className="p-6 md:p-10 space-y-4 md:space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <input type="text" placeholder="0912-345-678" value={regPhone} onChange={e => setRegPhone(e.target.value)} className="w-full px-5 py-3.5 md:py-4 rounded-xl md:rounded-2xl border border-slate-200 focus:ring-2 focus:ring-blue-800 outline-none text-sm md:text-base" />
              </div>
            </div>
            <div className="space-y-2">
