        ...
        <div className="p-6 md:p-10 space-y-4 md:space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <input type="text" placeholder="您的姓名" className="w-full px-5 py-3.5 md:py-4 rounded-xl md:rounded-2xl border border-slate-200 focus:ring-2 focus:ring-blue-800 outline-none text-sm md:text-base" />
            </div>
            <div className="space-y-2">
              <label className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest">手機號碼</label>
              <input type="text" placeholder="0912-345-678" className="w-full px-5 py-3.5 md:py-4 rounded-xl md:rounded-2xl border border-slate-200 focus:ring-2 focus:ring-blue-800 outline-none text-sm md:text-base" />
            </div>
          </div>
          <div className="space-y-2">
            <label className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest">Email</label>
            <input type="email" placeholder="example@email.com" className="w-full px-5 py-3.5 md:py-4 rounded-xl md:rounded-2xl border border-slate-200 focus:ring-2 focus:ring-blue-800 outline-none text-sm md:text-base" />
          </div>
          <div className="space-y-2">
            <label className="text-[10px] md:text-xs font-bold text-slate-400 uppercase tracking-widest">設定密碼</label>
            <input type="password" placeholder="••••••••" className="w-full px-5 py-3.5 md:py-4 rounded-xl md:rounded-2xl border border-slate-200 focus:ring-2 focus:ring-blue-800 outline-none text-sm md:text-base" />
          </div>
          <div className="flex items-start gap-3 p-4 bg-slate-50 rounded-xl md:rounded-2xl border border-slate-100">
            <input type="checkbox" className="mt-1 w-4 h-4 text-blue-800 rounded border-slate-300 focus:ring-blue-800" />
          ...
          <button 
            onClick={() => { setRole('MEMBER'); handleSetView('QA'); }}
            className="w-full bg-navy-700 text-white py-3.5 md:py-4 rounded-xl md:rounded-2xl font-bold text-base md:text-lg shadow-xl shadow-blue-900/20 hover:bg-blue-950 transition-all active:scale-[0.98]"
          >
            立即註冊
          </button>
        </div>
